...
export const getTransactionStatusTool = {
  ...
  description:
    "Check the on-chain status of a transaction by its hash. Returns status, block number, gas used, and explorer link.",
  inputSchema: getTransactionStatusSchema,
};

export async function handleGetTransactionStatus(raw: GetTransactionStatusInput) {
