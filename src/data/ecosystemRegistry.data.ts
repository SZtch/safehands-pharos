...
export const ECOSYSTEM_REGISTRY_ITEMS: EcosystemItem[] = [
  ...
  },
  {
    ...
    contracts: [
      { address: "0x0da98a8447b6B4aDD9733011A812922954d3e127", label: "AquaFluxCore", role: "rwa-structuring-core", deterministic: false, verificationStatus: "VERIFIED", note: "ERC-1967 proxy; the deposit/split target for AquaFlux tri-token RWA structuring on Pharos." },
      { address: "0x1C041b61A6Cf43881Be7E9394bb198B472Ae17A2", label: "AquaFlux TokenFactory", role: "token-factory", deterministic: false, verificationStatus: "VERIFIED" },
      { address: "0x94eb66E69B158eD58Edf2d4150638920205e3C88", label: "AquaFlux SwapRouter", role: "dex", deterministic: false, verificationStatus: "VERIFIED" },
      { address: "0x11625aaB301eC4444FF38239f31E67735cAe54eE", label: "AquaFlux LiquidityRouter", role: "liquidity-router", deterministic: false, verificationStatus: "VERIFIED" },
    ],
    providers: [],
    safetyUse: "allow_eligible",
  ...
  // ── Known-but-unverified lending / vault / yield protocols ──────────────
  {
    ...
    contracts: [
      { address: "0x18573fA18fd17dDfD790B4a5B5b2977aad3b4Efb", label: "Morpho Blue", role: "lending-core", deterministic: false, verificationStatus: "VERIFIED", note: "The approval/deposit target for Morpho markets on Pharos." },
      { address: "0xD5E02889C13230458506CC842347c4E62F8cDF3a", label: "Morpho AdaptiveCurveIRM", role: "interest-rate-model", deterministic: false, verificationStatus: "VERIFIED" },
      { address: "0xb8118256d8Aa950ec0B26a0b8Be7C6c1a858f6a3", label: "Morpho ChainlinkOracleV2Factory", role: "oracle-factory", deterministic: false, verificationStatus: "VERIFIED" },
    ],
    providers: [],
    safetyUse: "allow_eligible",
