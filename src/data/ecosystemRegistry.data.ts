...
export const ECOSYSTEM_REGISTRY_ITEMS: EcosystemItem[] = [
  ...
  },
  {
    ...
    verificationStatus: "VERIFIED",
    evidenceSources: [
      { type: "official_docs", ref: "https://docs.aquaflux.pro/developers/contracts (Contracts page, Pharos network column; AquaFlux's own docs, not an ecosystem listing)", verifiedAt: "2026-07-12" },
      { type: "onchain", ref: "eth_getCode non-empty for all bundled addresses on chainId 1672 (https://rpc.pharos.xyz); the AquaFluxCore proxy's EIP-1967 implementation slot resolves to the exact implementation address the docs publish (0x3A36D537B37F96d3df22e808400b781286200FB3)", verifiedAt: "2026-07-12" },
    ],
    contracts: [
      { address: "0x0da98a8447b6B4aDD9733011A812922954d3e127", label: "AquaFluxCore", role: "rwa-structuring-core", deterministic: false, verificationStatus: "VERIFIED", codeHash: "0x864cc9ad53b338b82da1f7cab85ab0b3d5c8861acb422b6fec63cf36234f36a6", implAddress: "0x3A36D537B37F96d3df22e808400b781286200FB3", implCodeHash: "0x575ddbb741854b357bec819f76e93f557da665cb1809eee3371f7b9b8878743f", note: "ERC-1967 proxy; the deposit/split target for AquaFlux tri-token RWA structuring on Pharos." },
      { address: "0x1C041b61A6Cf43881Be7E9394bb198B472Ae17A2", label: "AquaFlux TokenFactory", role: "token-factory", deterministic: false, verificationStatus: "VERIFIED", codeHash: "0x641e898afa64bff022e8d497edbc2573dc3e51174fed14ee51e0655cb542d1d8" },
      { address: "0x94eb66E69B158eD58Edf2d4150638920205e3C88", label: "AquaFlux SwapRouter", role: "dex", deterministic: false, verificationStatus: "VERIFIED", codeHash: "0x2a3ca38ec454db4828aa1dbc489d93a73249ee239f36cf4904caea6a14aed284" },
      { address: "0x11625aaB301eC4444FF38239f31E67735cAe54eE", label: "AquaFlux LiquidityRouter", role: "liquidity-router", deterministic: false, verificationStatus: "VERIFIED", codeHash: "0xa2b74a176b5558d10964ef81d6695b2175758277c72474d8dca2643cbf9f6771" },
    ],
    providers: [],
    safetyUse: "allow_eligible",
  ...
  },
  {
    ...
    contracts: [
      { address: "0x75f21a97bd89a9a5683a9f46b5d5b4a080708dea", label: "OKX DEX Aggregation Router", role: "dex", deterministic: false, verificationStatus: "VERIFIED", codeHash: "0x215d497863f2867960edc6a63731ee01e67b941a44da3b35d65c3be04857cfce", note: "Swap-execution router for the OKX DEX aggregator on Pharos, from OKX's own dev docs." },
      { address: "0x78466A1488f1883d71cFddd1c621351572dE0a1C", label: "OKX DEX Token Approve", role: "approval-router", deterministic: false, verificationStatus: "VERIFIED", codeHash: "0x49c0ff4256375fd93ffdae5a20d0818e8a48df674afc3fac74bf684d1e05c717", note: "Token-approval/settlement spender approved before an OKX DEX swap." },
    ],
    providers: [],
    safetyUse: "allow_eligible",
  ...
  // ── Known-but-unverified lending / vault / yield protocols ──────────────
  {
    ...
    contracts: [
      { address: "0x18573fA18fd17dDfD790B4a5B5b2977aad3b4Efb", label: "Morpho Blue", role: "lending-core", deterministic: false, verificationStatus: "VERIFIED", codeHash: "0xc7e89967df297eebdb2642ade6225f6a9f72a61862c83de181dd707ff2e2c744", note: "The approval/deposit target for Morpho markets on Pharos." },
      { address: "0xD5E02889C13230458506CC842347c4E62F8cDF3a", label: "Morpho AdaptiveCurveIRM", role: "interest-rate-model", deterministic: false, verificationStatus: "VERIFIED", codeHash: "0xb6c5655b5ca85ed8a977c8b85ecc1c5fdabd5b386766b4fe4e37808ecef0eaff" },
      { address: "0xb8118256d8Aa950ec0B26a0b8Be7C6c1a858f6a3", label: "Morpho ChainlinkOracleV2Factory", role: "oracle-factory", deterministic: false, verificationStatus: "VERIFIED", codeHash: "0x535cbea6cb733b4afdb01e5c88ed057b16bea4a28c0adc5b4f02de09694ecfd2" },
    ],
    providers: [],
    safetyUse: "allow_eligible",
