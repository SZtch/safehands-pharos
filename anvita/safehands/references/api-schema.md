...
{ "success": true, "riskScore": 45, "recommendation": "warn", "riskLevel": "medium",
  ...
  "onChain": { "balanceWei": "0", "txCount": 0, "isContract": false,
               "proxy": "(contract analysis only) { isProxy, implementation?, implementationHasCode?, implementationLabel?, admin?, beacon? } from direct EIP-1967 slot reads; isProxy:null when the storage reads failed" },
