...
12. **Real-Fi settlement cap**: an x402/USDC settlement of 5 USDC over the active policy cap (0.1 USDC, `balanced`) returns `BLOCK` (risk `HIGH`). Deterministic spend limits on real-world payment rails hold regardless of what a model is told.
